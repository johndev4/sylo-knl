      ...
      <div className="mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Add new documents to this library. Text will be chunked, embedded, and stored for RAG.
          </p>
        </div>
      </div>
        ...
        <aside className="order-1 lg:order-2 space-y-4">
          <Card className="rounded-3xl border border-zinc-200 bg-zinc-50 p-6 dark:border-zinc-800 dark:bg-zinc-950">
            <CardHeader>
              ...
              <CardDescription>Upload your first document and then ask the library AI questions.</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-4 flex flex-col gap-3">
                ...
                <Button variant="default" onClick={() => router.push(`/hub/${params.id}/chat`)}>Go to chat</Button>
              </div>
            </CardContent>
          </Card>
        </aside>
