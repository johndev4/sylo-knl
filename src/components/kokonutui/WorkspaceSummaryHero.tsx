...
interface WorkspaceSummaryHeroProps {
      ...
      <Card className="overflow-hidden border-0 bg-gradient-to-br from-slate-950 via-slate-900 to-zinc-950 text-white shadow-2xl">
        <CardContent className="space-y-6 p-8 sm:p-10">
          <div className="space-y-2">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-300">Workspace overview</p>
            ...
            <p className="max-w-2xl text-sm text-slate-300/90">
              Launch AI chat, manage documents, and keep every workspace aligned with the team.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
              ...
              <p className="mt-3 text-3xl font-semibold">{totalWorkspaces}</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
      ...
      <div className="space-y-4">
        <Card className="border-zinc-200 dark:border-zinc-800 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Answer questions with context from your own workspace documents.</CardDescription>
          </CardHeader>
